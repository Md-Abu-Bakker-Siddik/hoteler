 ...
 */
require_once HOTELER_FRAMEWORK_DIR . '/tgm/class-tgm-plugin-activation.php';

add_action( 'tgmpa_register', 'hoteler_register_required_plugins' );
 ...
 */
function hoteler_register_required_plugins() {
	$plugins_path = HOTELER_FRAMEWORK_DIR . '/tgm/plugins';
	...
	$plugins = array(
		array(
			'name'         	=> 'Mascot Core - Hoteler',
			'slug'         	=> 'mascot-core-hoteler',
			'source'       	=> $server_path . 'mascot-core-elementor/mascot-core-hoteler.zip',
			'required'     	=> true,
			'version'      	=> '1.0'
		),
		array(
	 ...
	 */
	$config = array(
		'id'           => 'hoteler',                 // Unique ID for hashing notices for multiple instances of TGMPA.
		...
		'message'      => '<div class="notice notice-info is-dismissible mt-20">
			...
			<p><strong>Note from Author ' . HOTELER_AUTHOR . ':</strong> To ensure the latest version of <em>theme required</em> plugins, you must have the latest version of <strong>' . $theme_name . '</strong></p>
