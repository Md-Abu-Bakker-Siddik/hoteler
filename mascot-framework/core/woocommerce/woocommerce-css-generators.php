...
if (!function_exists('hoteler_shop_archive_settings_gutter_size')) {
	/**
	 * Generate CSS codes for Shop Column Spacing (Gutter Size) px
	 */
	function hoteler_shop_archive_settings_gutter_size() {
		...
		$column_gutter = $hoteler_redux_theme_opt[$var_name];
	...
	add_action('hoteler_dynamic_css_generator_action', 'hoteler_shop_archive_settings_gutter_size');
}


if (!function_exists('hoteler_shop_settings_product_price_color')) {
	/**
	 * Generate CSS codes for Product Price Color Color
	 */
	function hoteler_shop_settings_product_price_color() {
		global $hoteler_redux_theme_opt;
	...
	add_action('hoteler_dynamic_css_generator_action', 'hoteler_shop_settings_product_price_color');
}


if (!function_exists('hoteler_shop_settings_product_on_sale_tag_bg_color')) {
	/**
	 * Generate CSS codes for Product On Sale Tag Background Color
	 */
	function hoteler_shop_settings_product_on_sale_tag_bg_color() {
		global $hoteler_redux_theme_opt;
	...
	add_action('hoteler_dynamic_css_generator_action', 'hoteler_shop_settings_product_on_sale_tag_bg_color');
}
