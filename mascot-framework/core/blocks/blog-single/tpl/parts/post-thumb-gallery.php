<?php hoteler_enqueue_script_lightgallery(); ?>
<?php hoteler_enqueue_script_owl_carousel(); ?>
<?php $gallery_images = hoteler_get_rwmb_group_advanced( 'hoteler_' . "blog_mb_pf_gallery_settings",  "gallery_images", null, false, 'all', 'large' );?>
