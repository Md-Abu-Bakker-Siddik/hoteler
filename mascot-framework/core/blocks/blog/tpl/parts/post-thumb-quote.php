<?php
	$quote_quote = hoteler_get_rwmb_group( 'hoteler_' . "blog_mb_pf_quote_settings", 'quote' );
	$quote_author = hoteler_get_rwmb_group( 'hoteler_' . "blog_mb_pf_quote_settings", 'quote_author' );
	$quote_position = hoteler_get_rwmb_group( 'hoteler_' . "blog_mb_pf_quote_settings", 'quote_position' );
?>
