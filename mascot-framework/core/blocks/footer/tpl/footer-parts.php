	...
	<?php
	/**
	* hoteler_before_footer hook.
	*
	*/
	do_action( 'hoteler_before_footer' );
	?>
	<footer id="footer" class="footer <?php echo esc_attr( $footer_classes );?>">
	<?php
		/**
		* hoteler_footer_start hook.
		*
		*/
		do_action( 'hoteler_footer_start' );
	?>
		<div class="footer-widget-area">
			<?php if ( isset($footer_widget_area) && !empty($footer_widget_area) && mascot_core_hoteler_plugin_installed() ) { ?>
	...
	<?php
		/**
		* hoteler_footer_end hook.
		*
		*/
		do_action( 'hoteler_footer_end' );
	?>
	</footer>
	<?php
	/**
	* hoteler_after_footer hook.
	*
	*/
	do_action( 'hoteler_after_footer' );
	?>