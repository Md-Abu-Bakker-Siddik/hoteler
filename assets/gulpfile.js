...
gulp.task("default", function () {
  gulp.watch("scss/**/*.scss", gulp.series("sass-hoteler", "rtl-hoteler", "hoteler-shop", "rtl-hoteler-shop", "hoteler-kodelisting", "rtl-hoteler-kodelisting", "sass-custom-admin-hoteler"));
});

//Task 1 - scss to css
gulp.task("sass-hoteler", function () {
  return gulp
...
gulp.task("rtl-hoteler", function () {
  return gulp
...
gulp.task("sass-custom-admin-hoteler", function () {
  return gulp
