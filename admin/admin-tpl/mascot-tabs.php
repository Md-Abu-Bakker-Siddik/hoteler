...
<?php
$links = array(
	'mascot-about'			  	=> esc_html__( 'About', 'hoteler' ),
	'mascot-docs' 				=> esc_html__( 'Support & Help', 'hoteler' ),
	'mascot-faq' 				=> esc_html__( 'FAQ', 'hoteler' ),
	'mascot-system-status'     	=> esc_html__( 'System Status', 'hoteler' ),
);
